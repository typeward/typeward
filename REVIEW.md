...
- Batch 8 (remainder: D-3/D-4 Android keyring + git2/OpenSSL, P-8i mobile size, CP-1 `compile_*` extraction — all `unverified-on-host`; plus held-back `vite` 8.1 + deferred `pdfjs-dist` 6.1 minor), residual P-2c — PENDING.
