...
- **Staging push** (Integ Phase 7.5) — `supabase db push` against `aepfxzsnhjonzevwglgr` is user-driven; the migrations and seeds are committed, waiting to be applied.
