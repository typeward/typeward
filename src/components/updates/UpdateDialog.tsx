...
export const UpdateDialog: Component = () => {
  ...
  const close = () => {
    ...
    // Release the plugin's Update handle too, or the Rust-side resource it
    // holds lives until the app exits.
    discardPendingUpdate();
        ...
        {(i) => (
          <div class="flex flex-col gap-3">
            ...
            <div class="text-xs text-fg-3">
              Typeward saves your open files first, then closes and reopens on
              the new version.
            </div>
          </div>
        )}
