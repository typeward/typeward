      ...
      >
        ...
        <div class="flex flex-col gap-3 border-t border-glass-stroke px-5 py-3.5">
          ...
          <p class="text-xs leading-relaxed text-fg-3">
            The name and email pre-fill the author of new projects, and the name
            signs your review comments, so anyone you share a project folder
            with sees it. It starts as your computer account name. Git commits
