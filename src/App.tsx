...
import { installDeadlineWatch } from "~/lib/deadline-watch";
...
const AppShell: Component<{ children?: any }> = (props) => {
  ...
  // Deadline reminders. Lives here rather than on the Projects screen so a
  // session that opens straight into the editor still gets them.
  installDeadlineWatch();
