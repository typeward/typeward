...
// digests as win32:x64, it just runs emulated. This only serves LOCAL ARM64
// dev builds: the CI ARM64 legs (Windows and Linux) deliberately ship without
// the sidecar at all, building with tauri.no-tectonic.conf.json instead (see
// the Tectonic gotcha in CLAUDE.md). That is also why there is no linux:arm64
// entry here despite upstream shipping a native aarch64 musl binary.
